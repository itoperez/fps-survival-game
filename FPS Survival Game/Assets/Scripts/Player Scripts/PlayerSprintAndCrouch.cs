...
public class PlayerSprintAndCrouch : MonoBehaviour
{
    ...
    void Sprint()
    {
        ...
        } else
        {
            ...
            {
                sprint_Value += (sprint_Treshold / 2) * Time.deltaTime;
    ...
    void Crouch()
    {
        if (Input.GetKeyDown(KeyCode.C))
        {
            if (is_Crouching)
            {
                ...
                characterController.height = 1.8f;                                          // NEW -----------------
                characterController.center = new Vector3(0f, 1f, 0f);                     // NEW -----------------
            ...
            } else
            {
                ...
                characterController.height = 1.2f;                                        // NEW -----------------
                characterController.center = new Vector3(0f, 0.7f, 0f);                     // NEW -----------------
